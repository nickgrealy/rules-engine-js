...
var defaultFunction = function(){
	...
	var response = 'defaultFunction -> arguments: ' + RulesEngine.mapToString(args[0])
	console.log(response)
    return response
}

var obj1 = {a:1}, obj2 = {b:2}, obj3 = {c:3}, obj4 = {d:4}
var startsWithAA = function(a){return a.toString().indexOf('AA') == 0}
var startsWithBB = function(a){return a.toString().indexOf('BB') == 0}
